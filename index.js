...
button.addEventListener("click", function() {
    ...
    if (name1.value === "divyansh" && name2.value === "sanvi") {
        text.innerHTML = "Your love percentage is "+ "100% "+name1Value + " and "+ name2Value + " are so in love with each other.You'll always stay by eachother's side or in simple words we can say is DIVYANSH AND SANVI ARE SOULMATES!";
    }else if(name1.value === "sanvi" && name2.value === "divyansh"){
        text.innerHTML = "Your love percentage is "+ "100% Divyansh and  Sanvi are so in love with each other.You'll always stay by eachother's side or in simple words we can say is DIVYANSH AND SANVI ARE SOULEMATES!";
    }else if (name1.value === "shaziya" && name2.value === "divyansh") {
        text.innerHTML = "Your love percentage is 0% but your hate percentage is 100%";
    }else if (name1.value === "divyansh" && name2.value === "shaziya") {
        text.innerHTML = "Your love percentage is 0% but your hate percentage is 100%";
        ...
        if (randomNo<20 ) {
            ...
            text.innerHTML = "Your love percentage is "+ randomNo + "% "+ name1Value + " and "+ name2Value + " You guys are made for each other"
    }
}
});